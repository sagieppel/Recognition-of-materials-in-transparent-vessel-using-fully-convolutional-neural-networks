...
Image_Dir="Data_Zoo/Materials_In_Vessels/Test_Images_All/" #imput images for testing net
...
#-------------------------------------------------------------------------------------------------------------------------
NUM_CLASSES = 15+2+3+4 #Sum of classes for each catagory
...
#------------------------Save predicted labels and the labels in /label/ folder, and the label overlay on the image in /overlay/ folder
        misc.imsave(Pred_Dir + "/Label/Vessel/" + FileName + NameEnd, Vessel[0])
        ...
        misc.imsave(Pred_Dir + "/Label/AllPhases/" + FileName + NameEnd, AllPhases[0])
        misc.imsave(Pred_Dir + "/OverLay/AllPhases/" + FileName + NameEnd,Overlay.OverLayExactPhase(Images[0], AllPhases[0], w))
        misc.imsave(Pred_Dir + "/AllPredicitionsDisplayed/" + FileName + NameEnd, np.concatenate((Images[0], Overlay.OverLayLiquidSolid(Images[0],Vessel[0], w),Overlay.OverLayFillLevel(
                                                                                                      Images[0],
                                                                                                      OnePhase[0], w),
                                                                                                  Overlay.OverLayLiquidSolid(
                                                                                                      Images[0],
                                                                                                      LiquidSolid[0],
                                                                                                      w),
                                                                                                  Overlay.OverLayExactPhase(
                                                                                                      Images[0],
                                                                                                      AllPhases[0], w)),
                                                                                                 axis=1))
